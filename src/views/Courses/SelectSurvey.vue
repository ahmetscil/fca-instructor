  ...
  <div>
    ...
    <div class="row operationHeader my-0 pt-2 px-2">
      ...
      <div class="col-6 text-right">
        <button type="button" class="btn btn-sm btn-danger mr-1" @click="close('SelectSurvey')">Cancel</button>
      ...
      <div class="col-md-12">
        <form>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <v-select placeholder="Select Survey" :options="allSurveys" label="survey_Name"></v-select>
              <small>tek seferde tek survey seçmeye izin veriliyor.</small>
            </div>
          </div>
        </form>
      </div>
